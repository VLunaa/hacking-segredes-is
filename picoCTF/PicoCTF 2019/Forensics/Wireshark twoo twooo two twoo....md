...
Obtenemos una captura de red principalmente con tráfico HTTP y DNS:
...
Escaneando a través de las secuencias, vemos esto:
...
Date: Mon, 10 Oct 2022 01:39:16 GMT
...
Podemos observar muchas banderas, pero ninguna funciona.
...
Podemos ver tráfico a subdominios inexistentes de `reddshrimpandherring.com`. Intentemos acceder al dominio:
...
Esa bandera tampoco funciona, 

Sin embargo, los subdominios son un poco raros. Podrían parecerse a base64. Si los extraemos con algún bash voodoo y decodificamos, podemos obtener la bandera.
